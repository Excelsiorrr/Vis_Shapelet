...
class Model(PatchTST.Model):
    ...
    def __init__(self, configs):
        ...
        if self.data=='mitecg':
            ...
            self.projection_1= nn.Linear(
            self.num_prototypes*self.seq_len, configs.num_class)
            
        if self.data=='freqshape':
    ...
    def seg_prototype_loss(self,activations,x,prototype_vectors,outputs,select_prototype=False,no_variance_loss=False):
